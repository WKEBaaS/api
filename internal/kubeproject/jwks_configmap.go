...
func (s *service) CreateJWKSConfigMap(ctx context.Context, opt CreateJWKSConfigMapOption) error {
...
func (s *service) DeleteJWKSConfigMap(ctx context.Context, ref string) error {
