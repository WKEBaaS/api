...
func (s *service) GetRootClasses(ctx context.Context, db *gorm.DB) ([]models.Class, error) {
...
func (s *service) GetChildClasses(ctx context.Context, db *gorm.DB, pcid string) ([]models.Class, error) {
	var classes []models.Class
...
func (s *service) GetClassesChild(ctx context.Context, db *gorm.DB, classIDs []string) ([]models.ClassWithPCID, error) {
...
func (s *service) GetClassByID(ctx context.Context, db *gorm.DB, classID string) (*models.Class, error) {
...
func (s *service) GetClassPermissions(ctx context.Context, db *gorm.DB, classID string) ([]models.PermissionWithRoleName, error) {
...
func (s *service) UpdateClassPermissions(ctx context.Context, db *gorm.DB, classID string, permissions []models.Permission) error {
