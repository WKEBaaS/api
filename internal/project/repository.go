...
func (r *repository) Create(ctx context.Context, name string, description *string, entityID string, userID *string) (*string, *string, error) {
...
func (r *repository) DeleteByIDSoft(ctx context.Context, id string) error {
...
func (r *repository) DeleteByRefSoft(ctx context.Context, ref string) error {
...
func (r *repository) DeleteByRef(ctx context.Context, ref string) error {
	var project models.Project
	txErr := r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
...
func (r *repository) FindByID(ctx context.Context, id string) (*models.ProjectView, error) {
...
func (r *repository) FindByRef(ctx context.Context, ref string) (*models.ProjectView, error) {
	var project models.ProjectView
...
func (r *repository) FindAllByUserID(ctx context.Context, userID string) ([]*models.ProjectView, error) {
...
func (r *repository) UpdateByRef(ctx context.Context, ref string, project any, object any) error {
	err := r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
...
func (r *repository) IsOwner(ctx context.Context, projectRef string, userID string) (bool, error) {
	var project models.ProjectView
	if err := r.db.WithContext(ctx).
